...
public class UserWithdrawAppVO {
...
private Integer uwaId ;
	...
	public String getChkFailMsg() {
		return chkFailMsg;
	}

	public void setChkFaliMsg(String chkFailMsg) {
		this.chkFailMsg = chkFailMsg;
	}
	...
	public void setChkFailMsg(String chkFailMsg) {
		this.chkFailMsg = chkFailMsg;
	}
	...
	public int hashCode() {
		...
		return ( batchNo + "_" +account ).hashCode() ;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		UserWithdrawAppVO other = (UserWithdrawAppVO) obj;
		if (account == null) {
	...
	public String toString() {
		return "UserWithdrawAppVO [uwaId=" + uwaId + ", account=" + account + ", withdrawAmt=" + withdrawAmt
				+ ", chkState=" + chkState + ", chkFailMsg=" + chkFailMsg + ", tradeState=" + tradeState
				+ ", tradeFailMsg=" + tradeFailMsg + ", batchNo=" + batchNo + ", channelType=" + channelType
				+ ", channelName=" + channelName + ", orderNo=" + orderNo + ", channelAccount=" + channelAccount
				+ ", clientType=" + clientType + ", clientBrand=" + clientBrand + ", clientChannel=" + clientChannel
				+ ", clientModel=" + clientModel + ", clientSystemNo=" + clientSystemNo + ", clientDeviceNo="
				+ clientDeviceNo + ", clientVersion=" + clientVersion + ", clientIp=" + clientIp + ", createDt="
				+ createDt + ", createTm=" + createTm + ", sendState=" + sendState + ", transfer=" + transfer + "]";
	}
