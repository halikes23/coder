package com.codepandas.jscalpel.web.sys.constant;

public class CoderWebConstant { 
	 ...
	 * 配置文件路径
	 */
	public final static String CFG_BASE_PATH = "/data/codepandas/resource/jscalpel-web/" ;
