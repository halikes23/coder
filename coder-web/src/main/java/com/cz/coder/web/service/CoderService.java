...
public class CoderService {
	...
	public List<String> queryAllDatabases() {
		return this.coderDao.selectAllDatabases();
	}

	public List<String> queryTablesBySchema(String schema) {
		return this.coderDao.selectTablesBySchema(schema);
	}

	public List<ColumnVO> queryColumnsByTable(String schema , String table) {
		return this.coderDao.selectColumnsByTable(schema,table);
	}
	...
	public Map<String, Object> buildCode(String pkg , String schema, String table) {
		...
		List<ColumnVO> columns =this.coderDao.selectColumnsByTable(schema,table);
...
//	</select>
	...
	public static void main(String[] args) {
		...
		CoderService service = new CoderService() ;
